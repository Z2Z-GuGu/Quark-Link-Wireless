...
const char* blinker_object[] = {
  "get", "btn-123", "btn-7ty", "btn-yoe", "btn-hn0", "joy-3ck", "joy-93l", "ran-e3v", "ran-t5r", "col-5gs"};     //以指针形式定义，后面得改下面的取值形式
 ...
 * @fn      jsoneq
 * @brief   瀛楃涓叉瘮杈冨嚱鏁�
 * @param   json  寰呰В鏋愮殑瀹屾暣json瀛楃涓查鍦板潃
 * @param   tok   浣跨敤token姹犵殑鍏蜂綋token棣栧湴鍧�锛屽&token_pool[1]
 * @param   s     瑕佹瘮瀵圭殑鍏抽敭瀛楀瓧绗︿覆锛屽"user"
 * @return  0     瀛楃涓蹭笉鍚�
 *          1     瀛楃涓茬浉鍚�
 ****************************************************************************/
